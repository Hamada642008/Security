...
clicksearch.addEventListener('click',()=>{
    ...
    window.open('../products/index1.html',"_blank")
    }else if (inputsearch=='Doorbell'||inputsearch=='Doorbell security') {
    window.open('../products/index2.html',"_blank")
    }else if (inputsearch=='smart look') {
    window.open('../products/index3.html',"_blank")
    }else {
